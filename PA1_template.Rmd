...
The data give the number of steps recorded in each five minute interval of each date. From the summary of the data frame, we see that there are `r nNAvalues` missing values out of `r nRowsInDF` rows of data. Some exploration shows that all the missing values are limited to `r nMissingDays` particular days which have no recorded number of steps at any time of those `r nMissingDays` days.
